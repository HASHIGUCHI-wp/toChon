...
length_s, width_s, height_s = 112.0, 15.0, 19.0
...
mesh_name_f_init = "initWaterQuadSize0.2"
mesh_name_f_add = "addWaterQuadSize0.2"
...
max_number *= 2
output_span = max_number // 600

output_span_numpy = output_span * 5

dx = dx_mesh
area_start = ti.Vector([-110, -20.0, -80.0])
area_end = ti.Vector([90.0, 20.0, 40.0])

diri_area_start = [56.0, -8.0, -0.5]
diri_area_end = [56.0, 8.0, 20.0]
...
# print(msh_f_init.cells_dict[ELE_f].shape)
